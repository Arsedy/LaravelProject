  ...
  <div class="col-lg-10 mx-auto">
    ...
    <div class="card border-0 shadow-sm bg-dark text-white">
      <div class="card-header border-bottom border-secondary py-3 bg-dark">
        <h4 class="mb-0 text-white fw-bold">Edit Product: <span class="text-info">{{ $product->title }}</span></h4>
      </div>
          ...
          <div class="row">
              ...
              <div class="mb-3">
                ...
                <select name="category_id" id="category_id" class="form-select bg-secondary text-white border-secondary @error('category_id') is-invalid @enderror" required>
                  ...
                  @foreach($categories as $category)
                    <option value="{{ $category->id }}" class="bg-dark" {{ old('category_id', $product->category_id) == $category->id ? 'selected' : '' }}>
                      {{ $category->title }}
                    </option>
                  @endforeach
                </select>
            ...
            <div class="col-md-5 ps-md-4">
              ...
              <div class="mb-3">
                ...
                <!-- Image Preview Box -->
                <div class="mt-3 {{ $product->image ? '' : 'd-none' }}" id="previewContainer">
              ...
              <div class="mb-4">
                ...
                <select name="status" id="status" class="form-select bg-secondary text-white border-secondary @error('status') is-invalid @enderror">
                  <option value="1" class="bg-dark" {{ old('status', $product->status ? '1' : '0') == '1' ? 'selected' : '' }}>Active</option>
                  <option value="0" class="bg-dark" {{ old('status', $product->status ? '1' : '0') == '0' ? 'selected' : '' }}>Inactive</option>
                </select>
                @error('status')
                  <div class="invalid-feedback">{{ $message }}</div>
                @enderror
